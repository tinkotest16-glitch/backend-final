  ...
  return (
    <Layout>
      ...
      <div className="mb-8">
        ...
        <p className="text-trading-muted">Earn commissions by referring friends to ProTrader</p>
      </div>
      ...
      <Card className="trading-card mb-8">
        <CardHeader>
          ...
          <CardDescription className="text-trading-muted">
            Share this link with friends to earn 10% commission on their profitable trades
          </CardDescription>
        </CardHeader>
          ...
          {isLoading ? (
            ...
            <div className="text-center py-12">
              ...
              <p className="text-trading-muted mb-6">
                Start sharing your referral link to earn commissions from your friends' trading activities.
              </p>
              ...
              {referrals.map((referral: Referral) => (
                <div key={referral.id} className="flex items-center justify-between p-4 border border-trading-border rounded-lg">
                  ...
                  <div className="text-right">
                    <div className="font-bold text-trading-success">
                      {formatCurrency(parseFloat(referral.totalEarnings))}
                    </div>
                    <Badge 
                      variant="outline" 
                      className={`text-xs ${
                        parseFloat(referral.totalEarnings) > 0 
                          ? "border-trading-success text-trading-success" 
                          : "border-trading-muted text-trading-muted"
                      }`}
                    >
