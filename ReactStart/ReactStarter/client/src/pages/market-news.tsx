    ...
    <Layout>
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-trading-text mb-2">Market News & Alerts</h1>
            <p className="text-trading-muted">Stay updated with the latest market developments and trading alerts</p>
          </div>
